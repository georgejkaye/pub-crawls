...
const Page = () => {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      ...
      setUsers(users.filter((userCount) => userCount.userId != user?.userId))
      ...
      {!token || isLoadingFollows ? (
        ...
        <div className="flex flex-col gap-4 w-full">
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center">
            <SubmitButton
              label={
                isAddingFollower ? "Stop adding followers" : "Add followers"
              }
            ...
            <div className="flex flex-row gap-2 items-center">
              ...
              >
                ...
                <option value="venues-desc">Venues (high-low)</option>
                <option value="rating-asc">Venues (low-high)</option>
              </select>
            </div>
          </div>
          {isAddingFollower ? (
